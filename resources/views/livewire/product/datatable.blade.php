    ...
    <div class="space-y-4">
        <div class="flex">
            <div class="w-2/3">
                <div class="flex">
                    <input
                        ...
                        class="border text-light text-grey-700 pl-2"
                        placeholder="Search products..."
                    >
                    <p
                        wire:click="$set('openAdvancedFilters', {{ !$openAdvancedFilters }})"
            ...
            <div class="w-1/3 flex flex-row justify-center items-center">
                ...
                <select wire:model="itemsPerPage" class="w-full border bg-white rounded px-3 py-2 outline-none">
            ...
            @if($openAdvancedFilters)
                <div class="w-full p-8 bg-gray-200">
                    <div class="flex flex-column">
                        <div class="w-1/3 space-y-2">
                            <div class="px-2">
                                ...
                                <input
                                    wire:model="filters.minStock" class="w-full p-1" type="number"
                                >
                            </div>
                        </div>
                        <div class="w-1/3 space-y-2">
                            <div class="px-2">
                                ...
                                <input
                                    wire:model="filters.maxStock" class="w-full p-1" type="number"
                                >
                            </div>
                        </div>
                        <div class="w-1/3">
                    ...
                    <div class="w-full flex items-end justify-end mt-2">
                        <span wire:click="clearFilters" class="cursor-pointer">
                            Limpar filtros
                        </span>
                    </div>
                </div>
